...
export default function animationLogo() {
  ...
  const SPEED = 750;
  svgBomb.attr({ fill: 'r()#fff-#61DAFB' });
  ...
  let spark1 = Snap('#svg-spark1');
  let spark2 = Snap('#svg-spark2');
  let spark3 = Snap('#svg-spark3');
  let spark4 = Snap('#svg-spark4');
  let spark5 = Snap('#svg-spark5');
  let spark6 = Snap('#svg-spark6');
  let sparks = [spark0, spark1, spark2, spark3, spark4, spark5, spark6];
  let sparkLine = [
    [
      ['710.6', '158.4'],
      ['659.2', '51.4'],
